...
load_dotenv('product_service.env')
...
SECRET_KEY = os.environ.get('PS_SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('PS_DEBUG')

ALLOWED_HOSTS = os.environ.get('PS_ALLOWED_HOSTS','').split(', ')
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, '../shared_components/templates')
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'PORT': os.environ.get('PS_DB_PORT','5432')
    }
}
